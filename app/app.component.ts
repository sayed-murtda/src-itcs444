...
export class AppComponent {
  ...
  public appPages = [
    ...
    { title: 'Items', content: [{ title: 'Show', url: '/items' }]},
    { title: 'Employees', content: [{ title: 'switchShift', url: '/switch-shift' },{title:'request', url: '/request'} ]},
    { title: 'Management', content: [{ title: 'ShowEmployee', url: '/employees' },{ title: 'addEmployee', url: '/add' },{ title: 'addsuppliers', url: '/add-sup' },{ title: 'Request Supplier', url: 'suppliers/request' }, ]},
